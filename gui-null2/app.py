...
class GUI:
    ...
    def do_shell_commands(self):
        ...
        with st.sidebar.expander("🛠️ Shell Commands", expanded=False):
        ...
        with st.sidebar.expander("🤖 Model Settings", expanded=False):
            ...
            if provider == "OpenAI":
                model = st.selectbox(
                    "Select Model",
                    [
                        "gpt-4-turbo-preview",    # Latest GPT-4 Turbo (automatically updates)
                        ...
                        "gpt-3.5-turbo-0125",    # Latest GPT-3.5 snapshot
                    ],
                    index=0,
